  ...
  return (
    <>
      ...
      <div className="about-us-component">
        <div className="about">
          <img className="aboutImg" src="https://res.cloudinary.com/cn-project/image/upload/v1642092205/pana/misc/output-onlinepngtools_d346ft.png"></img>
          ...
          <h3>Who are we?</h3>
          <h5>Rosie, Rachel, Julija and Holly, based in Nottingham, UK. We met at work and found a shared interest in creating websites and also making lists! Join us as we delve into the world of online lists!</h5>
        </div>
      </div>
      {loggedIn ? <Footer /> : ""}
    </>
